...
<head>
	...
	<title>HakDuck - Shop Compare</title>
...
<body>
	...
	<!--compare-area start-->
	<div class="products-compare-area">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="compare-table table-responsive">
						<table class="table table-bordered text-center">
							<tr>
								...
								<td>
									<div class="compare-thumb">
										<img src="../assets/images/products/compare/1.jpg" alt="" />
										<h5><a href="#">Apple The New MacBook Retina</a></h5>
									</div>
								</td>
								<td>
									<div class="compare-thumb">
										<img src="../assets/images/products/compare/2.jpg" alt="" />
										<h5><a href="#">Vantech VP-153C Camera</a></h5>
									</div>
								</td>
								<td>
									<div class="compare-thumb">
										<img src="../assets/images/products/compare/3.jpg" alt="" />
										<h5><a href="#">Blue Yeti USB Microphone </a></h5>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td><strong>Wireless Compatibility</strong></td>
								<td>802.11abg, 802.11 A/C</td>
								<td>802.11abg, 802.11 A/C</td>
								<td>802.11abg, 802.11 A/C</td>
							</tr>
							<tr>
