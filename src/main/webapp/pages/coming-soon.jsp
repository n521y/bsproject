...
<head>
	...
	<title>HakDuck - Coming Soon</title>
...
<body>
  ...
  <![endif]-->
	...
	<!--coming-area start-->
	<div class="coming-soon-area display-table">
				...
				<div class="row">
					<div class="col-lg-8 offset-lg-2">
						<div class="coming-soon-msg text-center">
							...
							<div class="coming-countdown style-2 text-center">
								<div data-countdown="2020/08/01"></div>
							</div>
							<div class="social-icons style-2 mt-75">
								<div class="mb-15">
