...
public class UserServiceImpl implements IUserService {
    ...
    public User encryptPassword(User user) {
        ...
        String salt2 = "1";
        		//new SecureRandomNumberGenerator().nextBytes().toHex();
        user.setSalt(salt2);
        //使用Md5Util进行Md5盐值加密
        String encodedPassword = Md5Util.encrypt(user.getPassword(), salt2);
        //设置加密后的用户密码
    ...
    public boolean editPasswd(User user, String oldPassword) {
        try {
            ...
            //对原密码进行相同的加密
            String passwd = Md5Util.encrypt(oldPassword, salt2);
